...
RUN cd /usr/local/HelloWorldKZ && mvn assembly:assembly
...
CMD ["java", "-cp", "/usr/local/HelloWorldKZ/target/helloworld-0.0.1-SNAPSHOT-jar-with-dependencies.jar", "org.karpati.MainApp"]